...
public class Program {
	...
	public static void main(String[] args) {
		...
		do3aExercise1Solution();
		
		do3aExercise2Solution();
		
		do3bExercise1Solution();
		
		do3bExercise2Solution();
	}
	

	private static void do3aExercise1Solution() {
	...
	private static void do3aExercise2Solution() {
	...
	private static void do3bExercise1Solution() {
		...
		do {
			...
			if (month < 1 || month > 12) {
				...
				*/
				...
				isValid = (isLeapYear && month==2)?(day <= days[month-1]+1):(day <= days[month-1]);
	...
	private static void do3bExercise2Solution() {
		...
		do {
			...
			if (!isValid) {
				...
				String formattedDate = "" + day + suffix + " " + monthName[month-1] + ", " + year;
